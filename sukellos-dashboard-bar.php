<?php
/**
 * Plugin Name: Sukellos - Dashboard Bar
 * Plugin URI: https://wp-adminbuilder.com/dashboard-bar/
 * Description: Sukellos Framework Tools - Dashboard Bar
 * Version: 1.1.8
 ...
 *
 *
 * @package   WP-Sukellos-Dashboard-Bar
 * @author    Sukellos
 * @category  Admin
...
// Sukellos Framework
use Sukellos\Admin\WP_Sukellos_Dashboard_Bar_Admin;
 ...
 * @since 1.0.0
 */
final class WP_Sukellos_Dashboard_Bar_Loader extends WP_Sukellos_Fw_Loader {
    ...
    public function get_plugin() {
        ...
        return WP_Sukellos_Dashboard_Bar::instance();
    }
    ...
    public function get_plugin_admin() {
        ...
        return WP_Sukellos_Dashboard_Bar_Admin::instance();
    }
}
WP_Sukellos_Dashboard_Bar_Loader::instance();